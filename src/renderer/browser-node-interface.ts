  ...
  return [
    {
      ...
      capabilities: buildCapabilities({
        ...
        parameters: getGeminiImageParameterDefinitions("gemini-2.5-flash-image"),
        defaults: getGeminiImageDefaultSettings("gemini-2.5-flash-image"),
      }),
    },
    {
      providerId: "google-gemini",
      ...
      capabilities: buildCapabilities({
        ...
        acceptedInputMimeTypes: GEMINI_IMAGE_INPUT_MIME_TYPES,
        maxInputImages: GEMINI_MAX_INPUT_IMAGES,
        parameters: getGeminiImageParameterDefinitions("gemini-3-pro-image-preview"),
        defaults: getGeminiImageDefaultSettings("gemini-3-pro-image-preview"),
      }),
    },
    {
      providerId: "google-gemini",
      ...
      capabilities: buildCapabilities({
        ...
        acceptedInputMimeTypes: GEMINI_IMAGE_INPUT_MIME_TYPES,
        maxInputImages: GEMINI_MAX_INPUT_IMAGES,
        parameters: getGeminiImageParameterDefinitions("gemini-3.1-flash-image-preview"),
        defaults: getGeminiImageDefaultSettings("gemini-3.1-flash-image-preview"),
      }),
    },
    {
      providerId: "google-gemini",
      ...
      capabilities: buildCapabilities({
        ...
        maxInputImages: 0,
        parameters: getGeminiTextParameterDefinitions("gemini-3.1-flash-lite-preview"),
        defaults: getGeminiTextDefaultSettings("gemini-3.1-flash-lite-preview"),
      }),
    },
    {
      providerId: "google-gemini",
      ...
      capabilities: buildCapabilities({
        ...
        acceptedInputMimeTypes: [],
        maxInputImages: 0,
        parameters: getGeminiTextParameterDefinitions("gemini-3-flash-preview"),
        defaults: getGeminiTextDefaultSettings("gemini-3-flash-preview"),
      }),
    },
    {
      providerId: "google-gemini",
      ...
      capabilities: buildCapabilities({
        ...
        acceptedInputMimeTypes: [],
        maxInputImages: 0,
        parameters: getGeminiTextParameterDefinitions("gemini-2.5-pro"),
        defaults: getGeminiTextDefaultSettings("gemini-2.5-pro"),
      }),
    },
    {
      providerId: "google-gemini",
      ...
      capabilities: buildCapabilities({
        ...
        acceptedInputMimeTypes: [],
        maxInputImages: 0,
        parameters: getGeminiTextParameterDefinitions("gemini-2.5-flash"),
        defaults: getGeminiTextDefaultSettings("gemini-2.5-flash"),
      }),
    },
    {
      providerId: "google-gemini",
      ...
      capabilities: buildCapabilities({
        ...
        acceptedInputMimeTypes: [],
        maxInputImages: 0,
        parameters: getGeminiTextParameterDefinitions("gemini-2.5-flash-lite"),
        defaults: getGeminiTextDefaultSettings("gemini-2.5-flash-lite"),
      }),
    },
    {
      providerId: "openai",
